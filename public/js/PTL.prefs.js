  ...
  var defaultFeeds = [
    {
      ...
      "columns": [
        ...
        [
          ...
          {
            "url": "https://www.youtube.com/feeds/videos.xml?playlist_id=PLr9Yx3twkzdKeHHys5idVo9awbhK2eoKC",
            "name": "TI Official Videos Playlist",
            "type": "mixed",
            "limit": 220,
            "status": "on"
          },
    ...
    },
    {
      ...
      "columns": [
        ...
        [
          ...
          {
            "url": "https://www.laquadrature.net/en/press/feed/",
            "name": "Revue de presse – La Quadrature du Net",
            "type": "mixed",
            "limit": 220,
            "status": "off"
          }
    ...
    },
    {
      ...
      "columns": [
        [
          {
            "url": "https://blog.londolozi.com/feed/",
            "name": "Londolozi Blog",
            "type": "photo",
            "limit": 220,
            "status": "off"
        ...
        [
          ...
          {
            "url": "https://blog.flickr.net/feed/",
            "name": "Flickr Blog",
            "type": "photo",
            "limit": 220,
            "status": "off"
    ...
    },
    {
      ...
      "columns": [
        ...
        [
          ...
          {
            "url": "http://www.music-news.com/rss/UK/news?includeCover=true",
            "name": "Music News RSS feed",
            "type": "mixed",
            "limit": 220,
            "status": "off"
          },
        ...
        [
          ...
          {
            "url": "http://rssfeeds.webwire.com/WebWire-News-Music",
            "name": "WebWire | News by Industry : Music",
            "type": "mixed",
            "limit": 220,
            "status": "off"
          }
    ...
    },
    {
      ...
      "columns": [
        ...
        [
          ...
          {
            "url": "https://www.productionmusiclive.com/blogs/news.atom",
            "name": "Production Music Live - News",
            "type": "mixed",
            "limit": 220,
            "status": "off"
          }
    ...
    },
    {
      ...
      "columns": [
        [
          {
            "url": "http://www.engineeringexchange.com/profiles/blog/feed?xn_auth=no",
            "name": "Engineering Exchange - Everyone",
            "type": "mixed",
            "limit": 220,
            "status": "off"
          },
          {
            "url": "http://www.sciencedaily.com/rss/matter_energy/engineering.xml",
            "name": "Engineering News -- ScienceDaily",
            "type": "mixed",
            "limit": 220,
            "status": "off"
          },
        ...
        [
          ...
          {
            "url": "https://www.cyclingweekly.com/feed",
            "name": "Cycling Weekly",
            "type": "mixed",
            "limit": 220,
            "status": "off"
      ...
      "columns": [
        [
          ...
          },
          {
            ...
            "name": "vie-publique.fr - Actualités - dernières mises à jour",
            "type": "mixed",
            "limit": 220,
            "status": "off"
          }
