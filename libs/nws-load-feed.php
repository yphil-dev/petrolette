...
<div class="feedTitle">
<a title="'.$u.' URL error" href="'.$u.'"> Error</a></div>
    ...
    if($feedRss) {
        ...
        echo '
             <div class="feed" title ="'.$feedLink.'">
                 <div class="'.$title_class.'">
                     <span class="favicon">
                         <a class="nws-feed-icon" href="'.$u.'"><img src="libs/'.$favicon.'" /></a></span> <span class="nws-feed-link" data-url="'.$feedLink.'" title="'.$title_link.'">'.$feedTitle.'</span>
        ...
        foreach($items as $item) {
            if ($i++ < $numItems) {
                ...
                echo '
                          <li title="'.$description.'" data-url="'.$link.'" class="nws-feed-link ui-widget-content ui-state-default">'.$img.'<div class="nws-feed-text ui-helper-clearfix">'.$title.'
                              </div>
                          </li>';
            }
            else break;
